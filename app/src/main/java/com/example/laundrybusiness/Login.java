                        ...
                        if (putData.startPut()) {
                            if (putData.onComplete()) {
                                ...
                                if (result.equals("Login Success")) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), MainActivity.class);  // Navigate to MainActivity after success
                                    intent.putExtra("username", username);  // Pass username for welcome message
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
