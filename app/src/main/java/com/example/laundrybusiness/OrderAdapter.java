...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder> {
    ...
    private View.OnClickListener onItemClickListener; // Optional: for cleaner click handling
    ...
    public void onBindViewHolder(OrderViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Toast.makeText(holder.itemView.getContext(), "Viewing details for " + item.id + " (TODO: Start OrderDetailActivity)", Toast.LENGTH_SHORT).show();
        });
    }
